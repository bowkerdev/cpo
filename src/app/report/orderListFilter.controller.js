...
(function() {
  ...
  angular.module('cpo')
      ...
      function($http, $translate, CommonService, $location) {
        ...
        this.init = function(scope) {
          ...
          scope.documentTypes = [{
            ...
            {
              label: 'Non Trade Card',
              value: 'Non Trade Card',
              id: 'Non Trade Card'
            }
          ];
    ...
    .controller('orderListFilterCtrl', ['$uibModalInstance', '$scope', 'orderListFilterService', function(
      $uibModalInstance, $scope, orderListFilterService) {
