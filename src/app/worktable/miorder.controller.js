						...
						if(data.status == 0) {
							...
							if(data.output) {
								...
								if(status == 5) {
									...
									scope.gridOptions3.columnDefs = workTableCommonService.constructeAssignmentStaticColumns(scope, "miorderforecast", true, 100, "miorder_grid_3");
									...
									scope.gridOptions4.columnDefs = workTableCommonService.constructeAssignmentStaticColumns(scope, "miorderforecast", true, 100, "miorder_grid_4");
...
//					param['order']='asc';
								...
								case 2:
									{
										...
										scope.gridOptions2.columnDefs = workTableCommonService.constructeAssignmentStaticColumns(scope, "miorderforecast", true, 100, "miorder_grid_2");
				...
				this.refreshBno = function(scope) {
					...
					var documentId = scope.gridOptions2.data[0].documentId;
					var param = {
						"assignResultIds": listToString(selectedRows, 'assignResultId'),
						"isMI": "YES",
